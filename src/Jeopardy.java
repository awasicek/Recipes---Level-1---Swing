...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.setTitle("Jeopardy [Not Fake!]");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel head = createHeader("Topic Header Placeholder");
		...
		secondButton = createButton("$2000");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed == firstButton) {  
			...
			askQuestion("Who was the first president of the U.S.A.?", "George Washington", 1000);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What is the capitol of New York?", "Albany", 2000);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Otherwise
			...
			JOptionPane.showMessageDialog(null, "Sorry, that is incorrect. The correct answer is " + correctAnswer);
...
public void playJeopardyTheme() {
		try {
			AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("/Users/awasicek/Desktop/League/league-sounds/jeopardy.wav"));
